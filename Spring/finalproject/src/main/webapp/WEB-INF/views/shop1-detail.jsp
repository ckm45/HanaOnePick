    ...
    <div class="container pb-5">
        <div class="row">
            <div class="col-lg-5 mt-5">
                <div class="card mb-3">
                    <img class="card-img img-fluid" src="../../resources/shop1/img/${productName}.png" alt="Card image cap" id="product-detail">
                </div>
                <div class="row">
                    <!--Start Controls-->
                        ...
                        <div class="carousel-inner product-links-wap" role="listbox">
                            ...
                            <div class="carousel-item active">
                                <div class="row">
                                    <div class="col-4">
                                        <a href="#">
                                            <img class="card-img img-fluid" src="../../resources/shop1/img/${productName}.png" alt="Product Image 1">
                                        </a>
                                    </div>
                                    <div class="col-4">
                                        <a href="#">
                                            <img class="card-img img-fluid" src="../../resources/shop1/img/${productName}.png" alt="Product Image 2">
                                        </a>
                                    </div>
                                    <div class="col-4">
                                        <a href="#">
                                            <img class="card-img img-fluid" src="../../resources/shop1/img/${productName}.png" alt="Product Image 3">
                                        </a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="carousel-item">
                                <div class="row">
                                    <div class="col-4">
                                        <a href="#">
                                            <img class="card-img img-fluid" src="../../resources/shop1/img/${productName}.png" alt="Product Image 4">
                                        </a>
                                    </div>
                                    <div class="col-4">
                                        <a href="#">
                                            <img class="card-img img-fluid" src="../../resources/shop1/img/${productName}.png" alt="Product Image 5">
                                        </a>
                                    </div>
                                    <div class="col-4">
                                        <a href="#">
                                            <img class="card-img img-fluid" src="../../resources/shop1/img/${productName}.png" alt="Product Image 6">
                                        </a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="carousel-item">
                                <div class="row">
                                    <div class="col-4">
                                        <a href="#">
                                            <img class="card-img img-fluid" src="../../resources/shop1/img/${productName}.png" alt="Product Image 7">
                                        </a>
                                    </div>
                                    <div class="col-4">
                                        <a href="#">
                                            <img class="card-img img-fluid" src="../../resources/shop1/img/${productName}.png" alt="Product Image 8">
                                        </a>
                                    </div>
                                    <div class="col-4">
                                        <a href="#">
                                            <img class="card-img img-fluid" src="../../resources/shop1/img/${productName}.png" alt="Product Image 9">
                                        </a>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="/payForm" method="POST">
                            ...
                            <input type="hidden" name="storeName" value="맥도날드 철산역점">
                            <input type="hidden" name="storeCategoryCode" value="FD">
